...
public class App
	...
	public void create () {
		...
		shapeDrawer = new ShapeDrawer (batch,
									   textureAtlas.findRegion ("white_pixel"));

		camera0 = new OrthographicCamera ();
		camera1 = new OrthographicCamera ();
		viewport0 = new FitViewport ((float) 512,
									 512,
									 camera0);
		viewport1 = new FitViewport ((float) 512,
									 512,
									 camera1);
	...
	@Override
	public void render () {
		ScreenUtils.clear (new Color (0.05f,
									  0.05f,
									  0.05f,
									  1f));
		behaviorLogic.updateWithGraphics (Gdx.graphics.getDeltaTime (),
										  batch,
										  shapeDrawer,
										  new Viewport[]{viewport0, viewport1},
										  textureAtlas);
	}
	...
	public void resize (int width,
		...
		viewport1.update (width / 2,
						  height,
						  true);
		viewport0.update (width / 2,
						  height,
						  true);
