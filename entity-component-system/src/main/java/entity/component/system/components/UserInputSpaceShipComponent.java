...
public enum UserInputSpaceShipComponent {
	PLAYER_ONE ( Input.Keys.W, Input.Keys.S, Input.Keys.D, Input.Keys.A, Input.Keys.E, Input.Keys.Q, Input.Keys.SHIFT_LEFT ),
	PLAYER_TWO ( Input.Keys.I, Input.Keys.K, Input.Keys.L, Input.Keys.J, Input.Keys.O, Input.Keys.U, Input.Keys.SPACE );
