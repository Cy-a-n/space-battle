...
public class UserInputSpaceShipLogic {
	...
	void update () {
		for (final @NotNull SpaceShipLocalPlayerBehavior entity : entities) {
			final @NotNull UserInputSpaceShipComponent userInput = entity.getUserInputSpaceShipBehavior();
			...
			// translationalThrustDirection.nor(); // I am unsure about this
			translationalThrustDirection.rotateDeg(entity.getPositionRotationComponent().getDegrees());
