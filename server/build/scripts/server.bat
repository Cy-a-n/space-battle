...
set CLASSPATH=%APP_HOME%\lib\space-battle-1.0.0.jar;%APP_HOME%\lib\shared-1.0.0.jar


@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" space.battle.client.ServerLauncher %*
